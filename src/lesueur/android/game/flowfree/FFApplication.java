...
public class FFApplication extends Application
{
    ...
    public void onCreate()
    {
    	...
    	xmlPuzzles.add("<flowpuzzles><flowpuzzle width=\"7\" height=\"7\">" + 
				...
				"</flowpuzzle></flowpuzzles>") ;
    	xmlPuzzles.add("<flowpuzzles><flowpuzzle width=\"7\" height=\"7\">" + 
				"<line><colors value=\"bblue\"/><src x=\"0\" y=\"0\"/><dst x=\"2\" y=\"6\"/></line>" + 
				"<line><colors value=\"yellow\"/><src x=\"0\" y=\"1\"/><dst x=\"5\" y=\"1\"/></line>" + 
				"<line><colors value=\"red\"/><src x=\"3\" y=\"1\"/><dst x=\"2\" y=\"4\"/></line>" + 
				"<line><colors value=\"green\"/><src x=\"1\" y=\"2\"/><dst x=\"1\" y=\"6\"/></line>" +
				"<line><colors value=\"orange\"/><src x=\"5\" y=\"2\"/><dst x=\"5\" y=\"5\"/></line>" +
				"</flowpuzzle></flowpuzzles>") ; 
    	FlowPuzzles fp  = null;
